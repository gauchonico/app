...
urlpatterns = [
    ...
    # path('chart-of-accounts/import/', views.import_chart_of_accounts, name='import_chart_of_accounts'),
    ...
    path('api/department-budget/<int:department_id>/', views.get_department_budget, name='get_department_budget'),
] 