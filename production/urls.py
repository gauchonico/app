...
urlpatterns = [
    ...
    path('bulk-upload-raw-material-prices/', views.bulk_upload_raw_material_prices, name='bulk_upload_raw_material_prices'),
    path('download-raw-material-price-template/', views.download_raw_material_price_template, name='download_raw_material_price_template'),
    ...
    path('raw_material_additions_detail/', views.raw_material_additions_detail, name="raw_material_additions_detail"),
    path('raw_material_deductions_detail/', views.raw_material_deductions_detail, name="raw_material_deductions_detail"),
    ...
    path('get-production-order-quantity/<int:production_order_id>/', views.get_production_order_quantity, name='get_production_order_quantity'),
    ...
    path('store_sale_receipt/<int:receipt_id>/', views.store_sale_receipt_detail, name='store_sale_receipt_detail'),
